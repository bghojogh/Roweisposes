...
method_and_options{2} = [1, 1]; %--> [r_1, r_2] in RDA or kernel RDA --> range of r_1 and r_2 \in [0,1]
method_and_options{3} = 'poly';  %--> kernel type over X in kernel RDA
...
%     M=[3;6;5;5;2;5;5;5;3;3;2];
    [E,P,Pi] = Train_the_HMM(test_person, u_norm_LDA, M, method_and_options, data_LDA);
    ...
    [estimated_action_HMM, estimated_action_MOTION, estimated_action_TOTAL, HMM_confidence, estimatedMatrix_action_HMM, confidenceMatrix_action_HMM] = Test(test_person, u_norm_LDA, E, P, Pi, estimated_action_HMM, estimated_action_MOTION, estimated_action_TOTAL, HMM_confidence, mean_histogram_1D, estimatedMatrix_action_HMM, confidenceMatrix_action_HMM, method_and_options, data_LDA);
